...
export class ChatRoomAndMessageArchiveTable1729939916559 implements MigrationInterface {
    name = 'ChatRoomAndMessageArchiveTable1729939916559'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`message_arches\` ADD CONSTRAINT \`FK_d2977b61e727de8e24a47b7eef3\` FOREIGN KEY (\`chat_room_id\`) REFERENCES \`chat_rooms\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
